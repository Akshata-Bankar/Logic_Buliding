...
/*
    START
        ...
        otherwisae display it is not divisible by 3,5
    STOP
*/
...
//Description:      Used to cechk whether number is divisible by 3 & 5 // check asel tr booleanch use karych
//Input:            Integer
//Output:           Boolean
...
/*
    logical && operator (ex.Adharcard and pancard)
